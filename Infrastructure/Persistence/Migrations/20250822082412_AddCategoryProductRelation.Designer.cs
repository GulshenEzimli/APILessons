...
namespace Persistence.Migrations
{
    ...
    [Migration("20250822082412_AddCategoryProductRelation")]
            ...
            modelBuilder.Entity("Domain.Entities.Brand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 890, DateTimeKind.Local).AddTicks(5328),
                            IsDeleted = false,
                            Name = "HP"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 893, DateTimeKind.Local).AddTicks(291),
                            IsDeleted = false,
                            Name = "Dilvin"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 893, DateTimeKind.Local).AddTicks(332),
                            IsDeleted = false,
                            Name = "DELL"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 895, DateTimeKind.Local).AddTicks(5039),
                            IsDeleted = false,
                            Name = "Elektrik",
                            ParentId = 0,
                            Priority = 1
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 895, DateTimeKind.Local).AddTicks(5062),
                            IsDeleted = false,
                            Name = "Moda",
                            ParentId = 0,
                            Priority = 2
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 895, DateTimeKind.Local).AddTicks(5064),
                            IsDeleted = false,
                            Name = "Bilgisayar",
                            ParentId = 1,
                            Priority = 1
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 895, DateTimeKind.Local).AddTicks(5066),
                            IsDeleted = false,
                            Name = "Kadın",
                            ParentId = 2,
                            Priority = 1
            ...
            modelBuilder.Entity("Domain.Entities.Detail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 896, DateTimeKind.Local).AddTicks(4647),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 896, DateTimeKind.Local).AddTicks(4667),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 896, DateTimeKind.Local).AddTicks(4669),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 896, DateTimeKind.Local).AddTicks(4671),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 896, DateTimeKind.Local).AddTicks(4674),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 2,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 896, DateTimeKind.Local).AddTicks(4678),
            ...
            modelBuilder.Entity("Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BrandId = 3,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 924, DateTimeKind.Local).AddTicks(7787),
                        ...
                        new
                        {
                            Id = 2,
                            BrandId = 1,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 924, DateTimeKind.Local).AddTicks(7927),
                        ...
                        new
                        {
                            Id = 3,
                            BrandId = 1,
                            Created = new DateTime(2025, 8, 22, 12, 24, 10, 924, DateTimeKind.Local).AddTicks(7932),
